    ...
    try {
      ...
      if (error) {
        if (error.message.includes('Invalid login credentials')) {
          ...
          setErrors({ submit: error.message || 'An error occurred during login. Please try again.' });
        }
      } else {
    ...
    <div className="min-h-screen bg-gradient-to-br from-cargo-50 to-blue-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <a href="#" className="text-cargo-600 hover:text-cargo-500 font-medium">
                  Forgot password?
                </a>
              </div>
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link to="/signup" className="text-cargo-600 hover:text-cargo-500 font-medium">
                Sign up here
              </Link>
            </p>
          </div>
        ...
        <div className="mt-8 text-center">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Why Choose CargoBridge?</h3>
